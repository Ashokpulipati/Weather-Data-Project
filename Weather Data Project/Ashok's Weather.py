...
lbl = Label(root, font="Courier", text="The Ultimate Ashok's Weather", fg="white", bg="#093a56")
lbl.place(x=270, y=1)
...
def weather(*args):
    try:
        city = ent.get()
        url = 'http://api.openweathermap.org/data/2.5/weather?q={}&appid=8a17f1cf513b4e0b95ecdc7f3bac1aa1&units=metric'.format(city)
...
def about_us():
    tm.showinfo("About Us", "This Is Developed By Ashok")
